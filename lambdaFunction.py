...
def lambda_handler(event, context):
    ...
    bucket_name = 'email-marketing-pc' # bucket name
    ...
    try:
        ...
        email_template = s3_client.get_object(Bucket=bucket_name, Key='email.html')
        ...
        for contact in contacts:
            ...
            response = ses_client.send_email(
                Source='prasannareddy2528@gmail.com',  # verified "From" address
